...
<div class="cards pt-3 mt-5 mb-5" id="cars">
  <div class="container-lg mt-5 cars">
    <div class="heading text-center text-dark pb-5">
      <h1 class="display-4 pt-3">All Removed cars </h1>
    </div>
    <div class="row">
    ...
    <input class="btn btn-outline-primary" type="submit"  value="search"></input>
      ...
      if(isset($_POST['search']))
      {
        ...
        $sql="SELECT * FROM removed_cars WHERE type='$car_name_for_search'"; 
        $search_cars=Remove::find_by_query($sql);
      ...
      else 
      {
        ...
        ?>
        <div class="col-xl-4 col-lg-4 col-md-4 p-5 ">
            <div class="card" style="width:300px;height: 360px;">
            <div class="img" widht="300px" height="150px" >
            <img src="../<?php echo $remove->picture_path();?>" width="300px" height="150px"
            style="border-top-left-radius: 40px;
            border-top-right-radius: 40px;">
            </div>
            <div class="text pt-2 text-dark">
            <p class="p">
              Car Name : <?php echo $remove->type;?>
            </p>
              <p class="p"> License Number : <?php echo $remove->license_number;?>  </p>
              <p class="p"> Color : <?php echo $remove->color;?></p>
              <p class="p">Rental Price : <?php echo $remove->rental_price;?>$</p>
              <p class="p">If Rentaled: <?php echo $remove->if_rentaled;?></p>
